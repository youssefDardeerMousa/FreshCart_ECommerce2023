                ...
                <div className={`collapse navbar-collapse ${collapsed ? '' : 'show'}`} id="navbarSupportedContent">
                    {isAuthenticated ? (
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <NavLink style={{ color: navbarColor1 }} className="nav-link" aria-current="page" to="/">
                                    Home
                                </NavLink>
                            </li>
                            <li className="nav-item">
                                <NavLink style={{ color: navbarColor1 }} className="nav-link" to="/Products">
                                    Products
                                </NavLink>
                            </li>
                            <li className="nav-item">
                                <NavLink style={{ color: navbarColor1 }} className="nav-link" to="/Categories">
                                    Categories
                                </NavLink>
                            </li>
                            <li className="nav-item">
                                <NavLink style={{ color: navbarColor1 }} className="nav-link" to="/Brands">
                                    Brands
                                </NavLink>
                            </li>
                        </ul>
                    ...
                    <ul className="navbar-nav ms-auto mb-2 mb-lg-0 mt-2">
                        {!isAuthenticated ? (
                            <>
                                <li className="nav-item">
                                    <NavLink style={{ color: navbarColor1 }} className="nav-link text-success fw-bold" to="/Register">
                                        Register
                                    </NavLink>
                                </li>
                                <li className="nav-item">
                                    <NavLink style={{ color: navbarColor1 }} className="nav-link text-success fw-bold" to="/Login">
                                        Login
                                    </NavLink>
                                </li>
                            </>
                            ...
                            <>
                                ...
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu bg-success" aria-labelledby="navbarDropdownMenuLink">
                                        <li className="nav-item">
                                            <Link onClick={logOut} to="/Login" style={{ color: navbarColor1 }} className="nav-link fw-bold text-dark">
                                                LogOut
                                            </Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link to="/ChangePass" className="nav-link fw-bold text-dark">
                                                ChangePass
                                            </Link>
                                        </li>
                                    </ul>
